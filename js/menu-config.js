var homeMenu = [
    ...
    },
    {
        ...
        children: [
            ...
            {name: '流动党员管理',url: 'html/debug.html'},
            {name: '党员注销管理',url: 'html/debug.html'},
            {name: '党费收缴管理',url: 'html/debug.html'},
            {name: '党员评议管理',url: 'html/debug.html'}
        ]
    },
    {
        name: '党员服务',
    ...
    },
    {
        ...
        icon: 'fa-th-large',
        children: [
            {name: '活动开展',url: 'html/debug.html'},
            {name: '活动情况统计',url: 'html/debug.html'}
        ]
    },
    {
        name: '居民议事',
